...
export const TUTORIAL_STEPS: Record<string, TutorialStep> = {
  ...
  simulation: {
    ...
    description: 'Each week, you play one game. Win to earn coins and build your win streak! Losses still give you 25 coins to keep progressing.',
  ...
  coins: {
    id: 'coins',
    title: '💰 Coins & Economy',
    description: 'Earn coins from wins, streaks, and milestones. Spend them on training, facilities, tactics, and players. Manage your budget carefully!',
    position: 'bottom',
    action: 'click',
    nextStep: 'facilities',
  },
  ...
  facilities: {
    id: 'facilities',
    title: '🏗️ Facilities',
    description: 'Upgrade 4 facilities: Stadium (coin multiplier), Training Center (better training), Medical (fatigue reduction), Scouting (opponent info).',
    target: '.facilities-button',
    position: 'left',
    action: 'click',
    nextStep: 'tactics',
  },
  ...
  tactics: {
    id: 'tactics',
    title: '📋 Tactics',
    description: 'Purchase and activate up to 3 tactics to boost your team. Each tactic modifies stats by percentages. Choose tactics that fit your team!',
    target: '.tactics-button',
    position: 'left',
    action: 'click',
    nextStep: 'chemistry',
  },
  ...
  chemistry: {
    ...
    description: 'Players have personalities that affect chemistry. Good chemistry boosts all stats by up to 10%. Build a team that works well together!',
  ...
  marketplace: {
    ...
    description: 'Buy and sell players to improve your roster. Market refreshes weekly. Look for young players with high potential!',
